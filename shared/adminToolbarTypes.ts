...
export const DEFAULT_AI_EMPLOYEES: AIEmployee[] = [
  {
    ...
    avatar: "🍀",
    description:
      "Master coordinator for all casino operations, providing oversight and detailed reports from all AI employee agents.",
    capabilities: [
  ...
  },
  {
    ...
    avatar: "🛡️",
    description:
      "Advanced security monitoring and fraud prevention specialist.",
    capabilities: [
  ...
  },
  {
    ...
    avatar: "����",
    description:
      "Expert in game operations, RTP optimization, and player engagement.",
    capabilities: [
  ...
  },
  {
    ...
    avatar: "💬",
    description:
      "Dedicated customer service and player satisfaction specialist.",
    capabilities: [
      "Player support",
      "Issue resolution",
      "Account assistance",
  ...
  },
  {
    ...
    avatar: "📊",
    description:
      "Advanced data analytics and business intelligence specialist.",
    capabilities: [
      "Data analysis",
      "Performance metrics",
