...
export const DEFAULT_COINKRAZY_SLOTS: SlotMachine[] = [
  {
    ...
    name: "Crypto Fortune",
    description:
      "Mine your way to digital riches with Bitcoin, Ethereum and CoinKrazy tokens!",
  ...
  },
  {
    ...
    name: "Space Odyssey",
    description:
      "Journey through the cosmos and discover stellar rewards among the stars!",
    theme: "Space Odyssey",
    provider: "CoinKrazy",
    thumbnail:
    ...
    bonusFeatures: [],
    soundEffects: {
      spinSound: "/sounds/space-spin.mp3",
      winSound: "/sounds/space-win.mp3",
      bonusSound: "/sounds/space-bonus.mp3",
      backgroundMusic: "/sounds/space-bg.mp3",
      volume: 0.7,
    },
    animations: {
      spinDuration: 2000,
  ...
  },
  {
    ...
    name: "Gaming Quest",
    description:
      "Level up through retro gaming worlds and unlock legendary power-ups!",
    ...
    bonusFeatures: [],
    soundEffects: {
      spinSound: "/sounds/game-spin.mp3",
      winSound: "/sounds/game-win.mp3",
      bonusSound: "/sounds/game-bonus.mp3",
      backgroundMusic: "/sounds/game-bg.mp3",
      volume: 0.7,
    },
    animations: {
      spinDuration: 2000,
  ...
  },
  {
    ...
    name: "Wild West Gold",
    description:
      "Strike it rich in the old frontier with outlaws, sheriffs, and golden nuggets!",
    ...
    bonusFeatures: [],
    soundEffects: {
      spinSound: "/sounds/west-spin.mp3",
      winSound: "/sounds/west-win.mp3",
      bonusSound: "/sounds/west-bonus.mp3",
      backgroundMusic: "/sounds/west-bg.mp3",
      volume: 0.7,
    },
    animations: {
      spinDuration: 2000,
  ...
  },
  {
    ...
    name: "Mystic Magic",
    description:
      "Cast spells and brew potions in this magical realm of wizards and enchantments!",
    theme: "Mystic Magic",
    provider: "CoinKrazy",
    thumbnail:
    ...
    bonusFeatures: [],
    soundEffects: {
      spinSound: "/sounds/magic-spin.mp3",
      winSound: "/sounds/magic-win.mp3",
      bonusSound: "/sounds/magic-bonus.mp3",
      backgroundMusic: "/sounds/magic-bg.mp3",
      volume: 0.7,
    },
    animations: {
      spinDuration: 2000,
