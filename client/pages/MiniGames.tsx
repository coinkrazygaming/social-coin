...
export default function MiniGames() {
  ...
  const miniGames: MiniGame[] = [
    ...
    },
    {
      ...
      description: "Fast-paced bean flicking action - click and drag to score!",
      icon: "🫘",
      maxReward: 0.25,
      duration: 60,
      available: true,
      component: FlickenMyBean,
    },
    {
      id: "deedees-fun-run",
      name: "DeeDee's Fun Run",
      description: "Endless runner adventure - jump over obstacles and collect coins!",
      icon: "🏃‍♀️",
      maxReward: 0.25,
      duration: 60,
      available: true,
      component: DeeDeeFunRun,
    },
    {
      id: "heathers-whack-a-corey",
      name: "Heather's Whack a Corey",
      description: "Classic whack-a-mole with a twist - whack Coreys but avoid bombs!",
      icon: "🔨",
      maxReward: 0.25,
      duration: 60,
      available: true,
      component: HeathersWhackACorey,
    },
    {
      id: "theresas-frogz",
      name: "Theresa's Frogz",
      description: "Hop across lily pads and catch flies for points!",
      icon: "🐸",
      maxReward: 0.25,
      duration: 60,
      available: true,
