...
export function Sportsbook() {
  ...
  >([
    {
      role: "ai",
      message:
        "Welcome to CoinKrazy Sportsbook! I'm LuckyAI, your Sportsbook Manager. I can help you understand odds, find value bets, and manage your wagering strategy. What can I help you with today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const teamFunFacts: Record<string, string> = {
    lakers:
      "The Lakers have won 17 NBA championships and their purple and gold colors were inspired by the University of Minnesota.",
    warriors:
      'Golden State Warriors have the best home court advantage with their "Roaracle" crowd atmosphere.',
    chiefs:
      "Kansas City Chiefs fans hold the Guinness World Record for loudest crowd roar at 142.2 decibels!",
    bills:
      'Buffalo Bills fans are famous for their tailgating tradition called "Bills Mafia" and jumping through tables.',
    heat: "Miami Heat's home court features one of the most challenging shooting backgrounds in the NBA.",
    celtics:
      "Boston Celtics have the most NBA championships with 17 titles and the famous parquet floor.",
  };
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-purple-200">
              Live Sports Betting with Gold Coins & Sweeps Coins
            </p>
          </div>
            ...
            <Tabs defaultValue="upcoming">
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm text-gray-400">
                                    {event.awayTeam.record?.wins}-
                                    {event.awayTeam.record?.losses}
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm text-gray-400">
                                    {event.homeTeam.record?.wins}-
                                    {event.homeTeam.record?.losses}
                            ...
                            <div className="mt-4">
                              ...
                              <div className="text-xs text-gray-300">
                                {teamFunFacts[event.homeTeam.id] ||
                                  teamFunFacts[event.awayTeam.id] ||
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <span>
                                  {formatOdds(event.odds.moneyline.away)}
                                </span>
                              </Button>
                              <Button
                                variant="outline"
                              ...
                              >
                                ...
                                <span>
                                  {formatOdds(event.odds.moneyline.home)}
                                </span>
                              </Button>
                            </div>
                          </div>
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  addToBetSlip(
                                    event,
                                    "spread",
                                    `${event.homeTeam.shortName} ${event.odds.spread.home.line > 0 ? "+" : ""}${event.odds.spread.home.line.toFixed(1)}`,
                                    event.odds.spread.home.odds,
                                  )
                                }
                              >
                                <span>
                                  {event.homeTeam.shortName}{" "}
                                  {event.odds.spread.home.line > 0 ? "+" : ""}
                                  {event.odds.spread.home.line.toFixed(1)}
                                </span>
                                <span>
                                  {formatOdds(event.odds.spread.home.odds)}
                                </span>
                              </Button>
                              <Button
                                variant="outline"
                                ...
                                onClick={() =>
                                  addToBetSlip(
                                    event,
                                    "total",
                                    `Over ${event.odds.total.over.line}`,
                                    event.odds.total.over.odds,
                                  )
                                }
                              >
                                <span>Over {event.odds.total.over.line}</span>
                                <span>
                                  {formatOdds(event.odds.total.over.odds)}
                                </span>
                              </Button>
                            </div>
                          </div>
              ...
              <TabsContent value="live" className="space-y-4">
                {liveEvents.map((event) => (
                  <Card
                    key={event.id}
                    className="bg-gray-800 border-gray-700 border-red-500"
                  >
                    <CardHeader>
                      <div className="flex justify-between items-center">
                        <CardTitle className="text-white flex items-center gap-2">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="gc" className="text-yellow-400">
                        Gold Coins (Fun Play)
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="SC" id="sc" />
                      <Label htmlFor="sc" className="text-green-400">
                        Sweeps Coins (Real Prizes)
                      </Label>
                    </div>
                  </RadioGroup>
                </div>
                  ...
                  {betSlip.bets.map((bet, index) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-400">
                        {bet.event.awayTeam.shortName} @{" "}
                        {bet.event.homeTeam.shortName}
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Input
                            ...
                            value={bet.stake}
                            onChange={(e) =>
                              updateBetStake(index, Number(e.target.value))
                            }
                ...
                <div className="border-t border-gray-600 pt-4 space-y-2">
                  <div className="flex justify-between text-white">
                    ...
                    <span>
                      {betSlip.totalStake.toFixed(2)} {betSlip.currency}
                    </span>
                  </div>
                  <div className="flex justify-between text-green-400 font-medium">
                    <span>Potential Win:</span>
                    <span>
                      {betSlip.totalPotentialWin.toFixed(2)} {betSlip.currency}
                    </span>
                  </div>
                </div>
