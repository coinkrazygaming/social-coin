...
export default function Index() {
  ...
  const recentWinners = [
    { username: 'LuckyPlayer77', game: 'Lightning Riches', amount: '15,000 SC' },
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted/20 py-16 sm:py-24">
        <div className={"absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%239C92AC\" fill-opacity=\"0.05\"%3E%3Ccircle cx=\"30\" cy=\"30\" r=\"4\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"} />
        ...
        <div className="container relative px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              Experience the ultimate sweepstakes casino with 500+ games, live sports betting, 
              and AI-powered features. Play with Gold Coins or win real Sweeps Coins!
            </p>
            
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-to-r from-gold to-yellow-400 text-gold-foreground hover:from-yellow-400 hover:to-gold casino-glow text-lg px-8 py-4">
                <Gift className="h-5 w-5 mr-2" />
                Claim Welcome Bonus
              </Button>
              <Button size="lg" variant="outline" className="border-sweep text-sweep hover:bg-sweep/10 text-lg px-8 py-4">
      ...
      <section className="py-16 bg-card/30">
        <div className="container px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2">Choose your adventure in our casino world</p>
          </div>
                ...
                <Link key={category.title} to={category.href}>
                  <Card className="group hover:scale-105 transition-all duration-300 border-border/40 hover:border-border bg-card/50 backdrop-blur">
                    <CardHeader className="text-center pb-4">
                      <div className={`mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br ${category.gradient} p-4 group-hover:shadow-lg transition-shadow`}>
                    ...
                    <CardContent className="text-center space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-casino-green">{category.players}</span>
                      </div>
                    </CardContent>
                  </Card>
                </Link>
        ...
        <div className="container px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Hottest games with biggest jackpots</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredSlots.map((slot) => (
              <Card key={slot.name} className="group overflow-hidden hover:scale-105 transition-all duration-300">
                ...
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    {slot.name}
                    <Badge variant="outline" className="text-sweep border-sweep">
                      {slot.jackpot}
                    </Badge>
                  </CardTitle>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Latest SC wins across all games</CardDescription>
              </CardHeader>
                ...
                {recentWinners.map((winner, index) => (
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-muted/20">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">{winner.game}</div>
                    </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="text-casino-red border-casino-red/30">
      ...
      <section className="py-16 bg-gradient-to-r from-gold/10 via-transparent to-sweep/10">
        <div className="container px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of players at CoinKrazy and experience the ultimate social casino 
            with AI-powered features, live sports betting, and real Sweeps Coin prizes!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-gradient-to-r from-gold to-yellow-400 text-gold-foreground hover:from-yellow-400 hover:to-gold casino-glow">
              <Coins className="h-5 w-5 mr-2" />
              Get 10,000 GC + 10 SC Free
            </Button>
            <Button size="lg" variant="outline" className="border-sweep text-sweep hover:bg-sweep/10">
