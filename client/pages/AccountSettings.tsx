      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-purple-200">Customize your CoinKrazy experience</p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Minimize motion effects for accessibility</p>
                    </div>
                    <Switch 
          ...
          <TabsContent value="notifications" className="space-y-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="text-white font-medium">General Notifications</h3>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Account updates and security alerts</p>
                        </div>
                      </div>
                      <Switch 
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Text messages for important updates</p>
                        </div>
                      </div>
                      <Switch 
                  ...
                  <div className="space-y-4">
                    <h3 className="text-white font-medium">Gaming Notifications</h3>
                    
                    <div className="flex items-center justify-between">
                      <div>
                        <Label className="text-white">Bonus Notifications</Label>
                        <p className="text-xs text-gray-400">Daily bonuses and promotions</p>
                      </div>
                      <Switch 
                        checked={settings.bonusNotifications} 
                        onCheckedChange={(checked) => updateSetting('bonusNotifications', checked)}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Big wins and jackpots</p>
                      </div>
                      <Switch 
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Bet results and live scores</p>
                      </div>
                      <Switch 
                        checked={settings.sportsbookNotifications} 
                        onCheckedChange={(checked) => updateSetting('sportsbookNotifications', checked)}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Promotional offers and newsletters</p>
                      </div>
                      <Switch 
          ...
          <TabsContent value="gaming" className="space-y-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="text-white font-medium">Gameplay Settings</h3>
                    
                    <div className="flex items-center justify-between">
                      <div>
                        <Label className="text-white">Auto Play</Label>
                        <p className="text-xs text-gray-400">Enable automatic spins</p>
                      </div>
                      <Switch 
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Faster slot animations</p>
                      </div>
                      <Switch 
                        checked={settings.quickSpin} 
                        onCheckedChange={(checked) => updateSetting('quickSpin', checked)}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Haptic feedback on mobile</p>
                      </div>
                      <Switch 
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Game sounds and alerts</p>
                      </div>
                      <Switch 
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Ambient casino music</p>
                      </div>
                      <Switch 
                    ...
                    <div>
                      ...
                      <div className="mt-2 px-3">
                        <Slider
                          ...
                          onValueChange={(value) => updateSetting('volumeLevel', value[0])}
                          max={100}
                          step={5}
                          className="w-full"
                        />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Help improve our platform</p>
                      </div>
                      <Switch 
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label className="text-white">Third-party Integration</Label>
                        <p className="text-xs text-gray-400">Connect with external services</p>
                      </div>
                      <Switch 
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Participate in global and game chats</p>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Allow others to send friend requests</p>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Receive private messages from other players</p>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Accept invitations to tournaments and events</p>
                    </div>
                    <Switch 
              ...
              <CardContent className="space-y-6">
                <div className="bg-yellow-900 border border-yellow-700 rounded-lg p-4 mb-6">
                  <p className="text-yellow-100 text-sm">
                    Set limits to help maintain healthy gaming habits. These limits will be enforced across all games and cannot be increased for 24 hours after setting.
                  </p>
                </div>

                <div className="space-y-6">
                  <div>
                    <Label className="text-white">Session Time Limit (minutes)</Label>
                    <div className="mt-2 px-3">
                      <Slider
                        value={[settings.sessionTimeLimit]}
                        onValueChange={(value) => updateSetting('sessionTimeLimit', value[0])}
                        max={480}
                        min={30}
                        step={30}
                        className="w-full"
                  ...
                  <div>
                    <Label className="text-white">Daily Deposit Limit (USD)</Label>
                    <div className="mt-2 px-3">
                      <Slider
                        value={[settings.dailyDepositLimit]}
                        onValueChange={(value) => updateSetting('dailyDepositLimit', value[0])}
                        max={1000}
                        min={50}
                        step={50}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="mt-2 px-3">
                      <Slider
                        ...
                        onValueChange={(value) => updateSetting('lossLimit', value[0])}
                        max={500}
                        min={20}
                        step={20}
                        className="w-full"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Periodic reminders about time and spending</p>
                    </div>
                    <Switch 
                      checked={settings.realityChecks} 
                      onCheckedChange={(checked) => updateSetting('realityChecks', checked)}
                    />
                  </div>
                </div>
              </CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Your personal casino guide and helper</p>
                    </div>
                    <Switch 
                      checked={settings.luckyAIEnabled} 
                      onCheckedChange={(checked) => updateSetting('luckyAIEnabled', checked)}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => updateSetting('luckyAIPersonality', value as any)}
                    >
                      <SelectTrigger className="mt-2">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="professional">Professional - Formal and informative</SelectItem>
                        <SelectItem value="friendly">Friendly - Warm and encouraging</SelectItem>
                        <SelectItem value="casual">Casual - Fun and relaxed</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="bg-blue-900 border border-blue-700 rounded-lg p-3">
                    <p className="text-blue-100 text-sm">
                      LuckyAI helps with game strategies, bonus information, and KYC guidance.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Social media content creator</p>
                    </div>
                    <Switch 
                      checked={settings.joseyAIEnabled} 
                      onCheckedChange={(checked) => updateSetting('joseyAIEnabled', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Video ads and social content creation</p>
                    </div>
                    <Switch 
                      checked={settings.joseyAISocialFeatures} 
                      onCheckedChange={(checked) => updateSetting('joseyAISocialFeatures', checked)}
                    />
                  </div>

                  <div className="bg-pink-900 border border-pink-700 rounded-lg p-3">
                    <p className="text-pink-100 text-sm">
                      JoseyAI creates personalized video ads and helps share your wins!
                    </p>
                  </div>
                </CardContent>
              </Card>
