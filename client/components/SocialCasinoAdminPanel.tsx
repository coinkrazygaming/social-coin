...
export function SocialCasinoAdminPanel() {
  ...
  const loadAdminData = async () => {
    try {
      ...
      // Load top performers
      const performers =
        await SpinLoggerService.getTopPerformers(selectedTimeframe);
    ...
    try {
      ...
      switch (type) {
        ...
        case "all":
          ...
          data = JSON.stringify(
            { spins: JSON.parse(spinsData), analytics: gameStats },
            null,
            2,
          );
          break;
      ...
      const blob = new Blob([data], {
        type: type === "spins" ? "text/csv" : "application/json",
      });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Comprehensive management and analytics for your social casino
            platform
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {realTimeStats.total_spins_today.toLocaleString()}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {realTimeStats.sc_earned_today.toFixed(2)}
                  </p>
                </div>
                        ...
                        >
                          ...
                          <div className="text-right">
                            <div className="font-bold">
                              {player.win_amount.toLocaleString()}{" "}
                              {player.currency}
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div className="text-right">
                            <div className="font-bold text-sweep">
                              {win.win_amount.toLocaleString()} {win.currency}
                            </div>
                  ...
                  <tbody>
                    {spinLogs.slice(0, 20).map((log) => (
                      <tr key={log.id} className="border-b hover:bg-muted/50">
                        ...
                        <td className="p-4">
                          {log.bet_amount} {log.currency}
                        </td>
                        <td className="p-4 text-green-600">
                          {log.win_amount} {log.currency}
                        </td>
                        <td
                          className={`p-4 ${log.net_result >= 0 ? "text-green-600" : "text-red-600"}`}
                        >
                          {log.net_result >= 0 ? "+" : ""}
                          {log.net_result}
                        </td>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {game.totalSpins.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gold">
                        {game.biggestWin.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-destructive">
                  ...
                  Suspicious Activity ({
                    topPerformers.suspiciousActivity.length
                  }{" "}
                  alerts)
                </CardTitle>
              </CardHeader>
                ...
                <div className="space-y-3">
                  {topPerformers.suspiciousActivity
                    ...
                    .map((alert: any, index: number) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-3 bg-destructive/10 rounded border border-destructive/20"
                      >
                        <div>
                        ...
                        <div className="text-right">
                          <div className="font-bold">
                            {alert.win_amount} {alert.currency}
                          </div>
                          <div className="text-xs text-muted-foreground">
