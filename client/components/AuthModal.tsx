    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
          ...
          <TabsContent value="register" className="space-y-4">
            ...
            <Alert className="bg-gradient-to-r from-gold/20 to-sweep/20 border-gold/30">
              ...
              <AlertDescription className="text-center font-medium">
                🎉 <strong>Welcome Bonus:</strong> Get 10,000 GC + 10 SC FREE on signup!
              </AlertDescription>
            </Alert>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="grid gap-1.5 leading-none">
                  ...
                  <p className="text-xs text-muted-foreground">
                    You must be 21+ to play. This is a social casino for entertainment purposes only.
                  </p>
                </div>
              </div>
        ...
        <div className="text-center pt-4 border-t space-y-2">
          <p className="text-sm text-muted-foreground">Join CoinKrazy and get:</p>
