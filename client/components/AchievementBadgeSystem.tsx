...
export function AchievementBadgeSystem() {
  ...
  const [achievements, setAchievements] = useState<Achievement[]>([
    {
      ...
      icon: "🎰",
      color: "#10B981",
      requirements: [{ condition: "games_played", value: 1 }],
      rewards: [
        {
          type: "badge",
          value: "first_spin_badge",
          description: "First Spin Badge",
        },
      ...
      milestones: [
        {
          ...
          name: "First Timer",
          requirement: 1,
          reward: { type: "gc", value: 500 },
        },
        {
          tier: 2,
          name: "Getting Started",
          requirement: 10,
          reward: { type: "gc", value: 1000 },
        },
        {
          tier: 3,
          name: "Regular Player",
          requirement: 50,
          reward: { type: "sc", value: 1 },
        },
        {
          tier: 4,
          name: "Dedicated Gamer",
          requirement: 100,
          reward: { type: "sc", value: 2 },
        },
        {
          tier: 5,
          name: "Slot Master",
          requirement: 500,
          reward: { type: "sc", value: 5 },
        },
      ],
      createdAt: new Date(),
      earnedBy: 847,
    ...
    },
    {
      ...
      icon: "🏆",
      color: "#F59E0B",
      requirements: [{ condition: "single_win", value: 1000 }],
      rewards: [
        {
          type: "badge",
          value: "big_winner_badge",
          description: "Big Winner Badge",
        },
      ...
      milestones: [
        ...
        },
        {
          ...
          name: "Jackpot Hunter",
          requirement: 10000,
          reward: { type: "sc", value: 10 },
        },
        {
          tier: 4,
          name: "Mega Winner",
          requirement: 25000,
          reward: { type: "vip_points", value: 100 },
        },
        {
          tier: 5,
          name: "Legendary Win",
          requirement: 50000,
          reward: { type: "title", value: "Legendary Winner" },
        },
      ],
      createdAt: new Date(),
      earnedBy: 234,
    ...
    },
    {
      ...
      rewards: [
        {
          type: "badge",
          value: "loyal_player_badge",
          description: "Loyal Player Badge",
        },
      ...
      milestones: [
        ...
        },
        {
          ...
          requirement: 90,
          reward: { type: "vip_points", value: 200 },
        },
        {
          tier: 5,
          name: "Eternal Devotee",
          requirement: 365,
          reward: { type: "title", value: "Eternal Player" },
        },
      ],
      createdAt: new Date(),
      earnedBy: 456,
    ...
    },
    {
      ...
      milestones: [
        ...
        },
        {
          ...
          name: "Big Spender",
          requirement: 250,
          reward: { type: "sc", value: 20 },
        },
        {
          tier: 3,
          name: "VIP Customer",
          requirement: 500,
          reward: { type: "vip_points", value: 500 },
        },
        {
          tier: 4,
          name: "Premium Player",
          requirement: 1000,
          reward: { type: "sc", value: 50 },
        },
        {
          tier: 5,
          name: "Elite Patron",
          requirement: 2500,
          reward: { type: "title", value: "Elite Patron" },
        },
      ],
      createdAt: new Date(),
      earnedBy: 123,
    ...
    },
    {
      ...
      name: "Mystery Master",
      description:
        "Unlock this secret achievement by discovering the hidden game",
      category: "special",
      type: "challenge",
      isActive: true,
      isSecret: true,
      ...
      icon: "🔮",
      color: "#EC4899",
      requirements: [{ condition: "hidden_game_found", value: 1 }],
      rewards: [
        {
          type: "badge",
          value: "mystery_master_badge",
          description: "Mystery Master Badge",
        },
        { type: "sc", value: 25, description: "25 Sweeps Coins" },
        {
          type: "title",
          value: "Mystery Master",
          description: "Mystery Master Title",
        },
      ],
      milestones: [
        {
  ...
  const [newAchievement, setNewAchievement] = useState({
    ...
    milestones: [
      { tier: 1, name: "", requirement: 0, reward: { type: "gc", value: 0 } },
    ],
  });
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-white font-medium">
                        {achievement.earnedBy.toLocaleString()}
                      </div>
                    </div>
                    <div>
                      <div className="text-gray-400">Total Rewards</div>
                      <div className="text-white font-medium">
                        {achievement.totalEarnings.toLocaleString()}
                      </div>
                    </div>
                  </div>
                        ...
                        .map((milestone, index) => (
                          ...
                          >
                            <span className="text-gray-400">
                              Tier {milestone.tier}: {milestone.name}
                            </span>
                            <Badge className="bg-green-600">
                              {milestone.reward.value}{" "}
                              {milestone.reward.type.toUpperCase()}
                            </Badge>
                          </div>
                        ))}
                    </div>
                  ...
                  <div className="text-center">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: badge.design.glow
                          ? `0 0 20px ${badge.design.primaryColor}40`
                          : "none",
                      }}
                    >
                      {badge.design.icon}
              ...
              <div className="space-y-4">
                {achievements.flatMap((achievement) =>
                  achievement.progressData.map((progress) => (
                    <div
                      key={`${achievement.id}-${progress.userId}`}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) =>
                        setNewBadge((prev) => ({ ...prev, rarity: value }))
                      }
                    >
                      <SelectTrigger className="mt-1">
                        <SelectValue />
                  ...
                  <div className="text-center">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: newBadge.design.glow
                          ? `0 0 20px ${newBadge.design.primaryColor}40`
                          : "none",
                      }}
                    >
