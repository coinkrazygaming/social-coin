...
export const VIPManagement: React.FC = () => {
      ...
      const realMembers: VIPMember[] = [
        {
          ...
          notes:
            "Excellent customer, very active player. Prefers slots and high-stakes games.",
        },
        {
          id: "member_002",
          userId: "user_67890",
          ...
          notes:
            "Top-tier customer. Interested in exclusive events and tournaments.",
        },
      ];

      const realStats: VIPStats = {
        totalMembers: realTiers.reduce(
          (sum, tier) => sum + tier.memberCount,
          0,
        ),
        activeMembers: realMembers.filter((m) => m.status === "active").length,
        monthlyRevenue: realTiers.reduce((sum, tier) => sum + tier.revenue, 0),
        averageLifetimeValue:
          realMembers.reduce((sum, m) => sum + m.lifetimeValue, 0) /
          realMembers.length,
        churnRate: 8.5,
        renewalRate: 91.5,
        mostPopularTier:
          realTiers.sort((a, b) => b.memberCount - a.memberCount)[0]?.name ||
          "None",
        conversionRate: 12.3,
      };
  ...
  const deleteTier = (tierId: string) => {
    if (
      confirm(
        "Are you sure you want to delete this VIP tier? All members will be moved to Bronze tier.",
      )
    ) {
  ...
  const filteredMembers = vipMembers.filter((member) => {
    ...
    const matchesTier =
      tierFilter === "all" || member.currentTier === tierFilter;
    const matchesStatus =
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    ${(stats.averageLifetimeValue / 1000).toFixed(0)}K
                  </p>
      ...
      <Tabs defaultValue="tiers" className="w-full">
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex justify-center gap-4 mt-2 text-xs">
                        <span className="text-gray-400">
                          3mo: ${tier.pricing.quarterly} (
                          {tier.pricing.discounts.quarterly}% off)
                        </span>
                        <span className="text-gray-400">
                          1yr: ${tier.pricing.yearly} (
                          {tier.pricing.discounts.yearly}% off)
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <TabsContent value="members" className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => setShowVIPCalculator(true)}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        ...
                        style={{
                          backgroundColor: getTierColor(member.currentTier),
                        }}
                      >
                        {vipTiers.find((t) => t.id === member.currentTier)
                          ?.icon || "👑"}
                      </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {member.addOns.map((addOn) => (
                          ...
                          >
                            {addOn.name} -{" "}
                            {formatTimeRemaining(addOn.expiryDate)}
                          </Badge>
                        ))}
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        {vipTiers.map((tier) => (
                          <SelectItem key={tier.id} value={tier.id}>
                            {tier.icon} {tier.name} - ${tier.pricing.monthly}
                            /month
                          </SelectItem>
                        ))}
                      </SelectContent>
                  ...
                  {calculatorData.tierId && (
                    <div>
                      ...
                      <div className="space-y-2 mt-2">
                        {vipTiers
                          .find((t) => t.id === calculatorData.tierId)
                          ?.addOns.map((addOn) => (
                            <div
                              key={addOn.id}
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Switch
                                  checked={calculatorData.addOns.includes(
                                    addOn.id,
                                  )}
                  ...
                  {calculatorData.tierId && (
                    <>
                      <div className="p-6 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 rounded-lg border border-yellow-500/30">
                        ...
                        {(() => {
                          const tier = vipTiers.find(
                            (t) => t.id === calculatorData.tierId,
                          );
                          if (!tier) return null;
                          ...
                          if (calculatorData.duration === 1) {
                            ...
                            basePrice =
                              tier.pricing.monthly * calculatorData.duration;
                          }

                          const originalPrice =
                            tier.pricing.monthly * calculatorData.duration;
                          const addOnPrice =
                            calculatorData.addOns.reduce((sum, addOnId) => {
                            ...
                            <div className="space-y-3">
                              <div className="flex justify-between">
                                <span className="text-gray-300">
                                  Base Price ({calculatorData.duration} months):
                                </span>
                              ...
                              {discount > 0 && (
                                <div className="flex justify-between">
                                  ...
                                  <span className="text-green-400">
                                    -$
                                    {((originalPrice * discount) / 100).toFixed(
                                      2,
                                    )}
                                  </span>
                                </div>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="text-blue-400">
                                  {tier.benefits.weeklyRewards.toLocaleString()}{" "}
                                  GC
                                </span>
                              </div>
                              <div className="flex justify-between">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-semibold">
                        +{selectedTier.benefits.bonusMultiplier}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">RTP Boost:</span>
                      <span className="text-green-400 font-semibold">
                        +{selectedTier.benefits.rtpBoost}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Weekly Rewards:</span>
                      <span className="text-blue-400 font-semibold">
                        {selectedTier.benefits.weeklyRewards.toLocaleString()}{" "}
                        GC
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Lossback:</span>
                      <span className="text-yellow-400 font-semibold">
                        {selectedTier.benefits.lossbackPercentage}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Birthday Bonus:</span>
                      <span className="text-purple-400 font-semibold">
                        {selectedTier.benefits.birthdayBonus.toLocaleString()}{" "}
                        GC
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="text-pink-400 font-semibold">
                        {selectedTier.benefits.freeSpins}/week
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-3 bg-gray-700 rounded">
                    ...
                    <p className="text-white font-semibold">
                      $
                      {selectedTier.benefits.withdrawalLimits.daily.toLocaleString()}
                    </p>
                  </div>
                  <div className="text-center p-3 bg-gray-700 rounded">
                    ...
                    <p className="text-white font-semibold">
                      $
                      {selectedTier.benefits.withdrawalLimits.weekly.toLocaleString()}
                    </p>
                  </div>
                  <div className="text-center p-3 bg-gray-700 rounded">
                    ...
                    <p className="text-white font-semibold">
                      $
                      {selectedTier.benefits.withdrawalLimits.monthly.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {selectedMember && (
                <>
                  <div
                    ...
                    style={{
                      backgroundColor: getTierColor(selectedMember.currentTier),
                    }}
                  >
                    {vipTiers.find((t) => t.id === selectedMember.currentTier)
                      ?.icon || "👑"}
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">
                        {selectedMember.expiryDate.toLocaleDateString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-semibold">
                        ${selectedMember.lifetimeValue.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">
                        $
                        {selectedMember.activity.totalDeposits.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">
                        $
                        {selectedMember.activity.totalWithdrawals.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400 font-semibold">
                        $
                        {(
                          selectedMember.activity.totalDeposits -
                          selectedMember.activity.totalWithdrawals
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-gradient-to-r from-green-600/20 to-emerald-600/20 rounded border border-green-500/30">
                    ...
                    <p className="text-green-400 font-semibold">
                      +{selectedMember.benefits.rtpBoost}%
                    </p>
                  ...
                  <div className="text-center p-3 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded border border-blue-500/30">
                    ...
                    <p className="text-blue-400 font-semibold">
                      +{selectedMember.benefits.bonusMultiplier}%
                    </p>
                  ...
                  <div className="text-center p-3 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded border border-purple-500/30">
                    ...
                    <p className="text-purple-400 font-semibold">
                      {selectedMember.benefits.personalManager || "None"}
                    </p>
                  ...
                  <div className="text-center p-3 bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded border border-yellow-500/30">
                    ...
                    <p className="text-yellow-400 font-semibold">
                      {selectedMember.benefits.customLimits ? "Yes" : "No"}
                    </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <div className="text-white font-semibold">
                      {selectedMember.activity.lastLogin.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-400">Favorite Game:</span>
                    <div className="text-white font-semibold">
                      {selectedMember.activity.favoriteGame}
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-400">Avg Session:</span>
                    <div className="text-white font-semibold">
                      {selectedMember.activity.averageSession} min
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-400">Games Played:</span>
                    <div className="text-white font-semibold">
                      {selectedMember.activity.gamesPlayed.length} types
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewTier((prev) => ({ ...prev, color: e.target.value }))
                  }
                />
              </div>
              <div>
                ...
                <Input
                  value={newTier.icon || "👑"}
                  onChange={(e) =>
                    setNewTier((prev) => ({ ...prev, icon: e.target.value }))
                  }
                  placeholder="👑"
                />
              </div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewTier((prev) => ({
                      ...
                      benefits: {
                        ...prev.benefits,
                        rtpBoost: parseFloat(e.target.value),
                      },
                    }))
                  }
                />
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewTier((prev) => ({
                      ...
                      benefits: {
                        ...prev.benefits,
                        weeklyRewards: parseInt(e.target.value),
                      },
                    }))
                  }
                />
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewTier((prev) => ({
                      ...
                      benefits: {
                        ...prev.benefits,
                        lossbackPercentage: parseFloat(e.target.value),
                      },
                    }))
                  }
                />
