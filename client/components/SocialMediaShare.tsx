...
import { Share2, Twitter, Facebook, Instagram, Linkedin, Link, Copy, Check, Download, Image, Video, Users, TrendingUp } from 'lucide-react';
...
export const SocialMediaShare: React.FC<SocialMediaShareProps> = ({ className = '' }) => {
  const [activeTab, setActiveTab] = useState<'quick-share' | 'content-creator' | 'analytics'>('quick-share');
  ...
  const renderQuickShare = () => (
    <div className="space-y-4">
      <div>
        <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Quick Share Links</h4>
        <div className="space-y-3">
          {quickShareLinks.map((link) => (
            <div key={link.id} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                ...
                {socialPlatforms.slice(0, 3).map((platform) => {
                  ...
                  return (
                    <Button
                      ...
                      onClick={() => window.open(generateShareUrl(platform.id, link.description, link.url), '_blank')}
                    >
      ...
      <div>
        <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Custom Share Message</h4>
        <div className="space-y-3">
          <Textarea
            ...
            {socialPlatforms.map((platform) => {
              ...
              return (
                <Button
                  ...
                  onClick={() => window.open(generateShareUrl(platform.id, customMessage, 'https://coinkrizy.com'), '_blank')}
  ...
  const renderContentCreator = () => (
    <div className="space-y-6">
      <div>
        <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Content Templates</h4>
        <div className="space-y-3">
          {socialTemplates.map((template) => (
            <div key={template.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
      ...
      <div>
        <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Platform Guidelines</h4>
        <div className="grid gap-3">
          {socialPlatforms.map((platform) => {
            const PlatformIcon = platform.icon;
            return (
              <div key={platform.id} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{platform.tips}</p>
                <div className="flex gap-2">
  ...
  const renderAnalytics = () => (
    <div className="space-y-6">
      <div>
        <h4 className="font-semibold text-gray-900 dark:text-white mb-4">Share Performance</h4>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-blue-600 dark:text-blue-400">Total Shares</div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-green-600 dark:text-green-400">Link Clicks</div>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-purple-600 dark:text-purple-400">Top Platform</div>
          </div>
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-orange-600 dark:text-orange-400">Engagement Rate</div>
          </div>
        </div>
      </div>

      <div>
        <h5 className="font-medium text-gray-900 dark:text-white mb-3">Recent Share Activity</h5>
        <div className="space-y-2">
          {mockAnalytics.recentShares.map((share, index) => {
            const platform = socialPlatforms.find(p => p.id === share.platform.toLowerCase());
