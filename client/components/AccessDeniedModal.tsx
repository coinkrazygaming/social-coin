...
export function AccessDeniedModal({ isOpen, onClose, feature }: AccessDeniedModalProps) {
  ...
  const getFeatureTitle = () => {
    switch (feature) {
      case 'mini-games': return 'Mini Games';
      case 'sweeps-coins': return 'Sweeps Coins Gameplay';
      case 'poker': return 'Poker Tournaments';
      case 'sportsbook': return 'Sportsbook Betting';
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-2xl p-0 overflow-hidden bg-gradient-to-br from-background via-background to-muted/20">
          ...
          <div className="relative bg-gradient-to-r from-gold via-yellow-400 to-gold p-6 text-center">
            <div className={"absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"0.1\"%3E%3Ccircle cx=\"30\" cy=\"30\" r=\"4\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"} />
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="text-center relative">
              ...
              <div className="relative inline-block">
                <div className="w-32 h-32 mx-auto mb-4 relative">
                  ...
                  <div className="absolute -right-12 top-10 text-2xl animate-pulse">👉</div>
                </div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                The World's First AI-Powered Social Casino & Sportsbook & Poker Tournaments & Bingo!
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gold/10 border border-gold/20 rounded-lg p-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">10,000 GC + 10 SC FREE!</p>
              </div>
              ...
              <div className="bg-sweep/10 border border-sweep/20 rounded-lg p-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">Free SC Every Day!</p>
              </div>
              ...
              <div className="bg-casino-red/10 border border-casino-red/20 rounded-lg p-4 text-center">
                ...
                <h3 className="font-semibold text-casino-red">Poker Tournaments</h3>
                <p className="text-sm text-muted-foreground">Live Player Competition</p>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Join Our Social Casino Community</h3>
              <p className="text-muted-foreground mb-4">
                Connect with thousands of players, compete in tournaments, and earn free Sweeps Coins daily!
              </p>
              <div className="flex justify-center space-x-4 text-sm">
                ...
                <Badge variant="outline" className="bg-sweep/20 text-sweep border-sweep/30">
                  <Zap className="h-3 w-3 mr-1" />
                  AI-Powered
                </Badge>
                <Badge variant="outline" className="bg-casino-green/20 text-casino-green border-casino-green/30">
