...
leaderboardEntries.set(
  "slots-sc",
  mockEntries.filter((e) => e.gameType === "slots"),
);
leaderboardEntries.set(
  "table-games-sc",
  mockEntries.filter((e) => e.gameType === "table-games"),
);
leaderboardEntries.set(
  "mini-games-sc",
  mockEntries.filter((e) => e.gameType === "mini-games"),
);
leaderboardEntries.set(
  "sportsbook-sc",
  mockEntries.filter((e) => e.gameType === "sportsbook"),
);
leaderboardEntries.set(
  "bingo-sc",
  mockEntries.filter((e) => e.gameType === "bingo"),
);
...
export const handleGetUserStats: RequestHandler = (req, res) => {
  ...
  const stats: UserStats = {
    ...
    totalWinnings: { GC: 125000, SC: 89.5 },
...
export const handleUpdateScore: RequestHandler = (req, res) => {
  ...
  const overallEntries =
    leaderboardEntries.get(`overall-${currency.toLowerCase()}`) || [];
